...
describe('Validator', ()=>{
    describe('isEmailValid', ()=>{
        it('return `true` 케이스', () => {
            expect(Validator.isEmailValid('hyeonsu@xquare.com')).toEqual(true);
        });
        it('should return `false` 케이스', () => {
            ...
            expect(Validator.isEmailValid('hyeonsu@')).toEqual(false);
            expect(Validator.isEmailValid('hyeonsu@xquare')).toEqual(false);
            expect(Validator.isEmailValid('hyeonsu@xquare.')).toEqual(false);
            expect(Validator.isEmailValid('hyeonsu@xquare.123')).toEqual(false);
            expect(Validator.isEmailValid('hyeonsu@xquare.com123')).toEqual(false);
        });
    });
